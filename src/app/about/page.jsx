    ...
    <div className="bg-white text-gray-900 max-w-6xl mx-auto px-5 leading-relaxed">
      ...
      <section className="py-16 text-center">
        ...
        <p className="text-gray-600 text-md md:text-lg leading-relaxed max-w-3xl mx-auto mb-6">
          We’ve built and managed <b>3,000+ eCommerce stores</b>. Our promise is
          simple: clear strategies, honest work, and results you can measure.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="transition-transform duration-200 ease-in-out hover:-translate-y-1 bg-gray-100 border border-gray-200 rounded-2xl p-6 shadow-md">
            ...
            <p className="text-gray-700">
              To make eCommerce success possible for every brand, big or small.
              We imagine a future where businesses of all sizes compete on equal
              grounds with smart strategies and strong execution.
            </p>
          </div>
          <div className="transition-transform duration-200 ease-in-out hover:-translate-y-1 bg-gray-100 border border-gray-200 rounded-2xl p-6 shadow-md">
            <h3 className="text-xl font-bold mb-2 flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="transition-transform duration-200 ease-in-out hover:-translate-y-1 bg-gray-100 border border-gray-200 rounded-2xl p-6 shadow-md">
            ...
            <p className="text-gray-700">
              ...
              <b>$50K+ monthly revenue in six months</b> using our simple growth
              plan. Many others now lead their niches with our support.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        ...
        <div className="bg-gray-100 border border-gray-200 rounded-2xl p-6 shadow-md">
          <p className="text-gray-700">
            ...
            ongoing support so you always feel confident in your growth journey.
          </p>
          <p className="text-gray-700 mt-4">
            When you partner with Betelbee, you get more than a service provider
            — you gain a trusted partner who treats your business like our own.
            We’re committed to helping you scale with clear plans, regular
            updates, and consistent results.
          </p>
        </div>
      </section>
