    ...
    <div className="bg-white max-w-6xl mx-auto px-5 text-black font-inter tracking-wide leading-relaxed">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-lg">
            <div className="grid grid-cols-3 gap-3">
              ...
              <div className="stat flex flex-col items-center justify-center bg-gray-100 border border-gray-200 p-4 rounded-xl text-center">
                ...
                <span className="text-gray-700 text-sm mt-1">ROI Targets</span>
              </div>
              <div className="stat flex flex-col items-center justify-center bg-gray-100 border border-gray-200 p-4 rounded-xl text-center">
      ...
      <section id="services" className="py-16">
        <div className="flex flex-col sm:flex-row items-start sm:items-baseline justify-between gap-4 mb-5">
          ...
          <p className="text-gray-700 max-w-3xl">
            Full‑stack e‑commerce operations: storefronts, sourcing, logistics,
            growth marketing, customer experience, data, marketplaces, and brand
            creative — all accelerated by practical AI.
          </p>
        </div>
      ...
      <section id="private-label" className="py-16">
        <div className="flex flex-col sm:flex-row items-start sm:items-baseline justify-between gap-4 mb-5">
          ...
          <p className="text-gray-700 max-w-3xl">
            We don’t just launch a product — we deliver a complete, retail‑ready
            brand: sourcing, design, website, social media, marketing, and
            ...
            <div>
              ...
              <ul className="list grid gap-2 mt-2">
                ...
                <li className="flex items-start gap-2 list-none">
                  ...
                  <b className="font-bold">Scale & Compliance:</b> forecasting,
                  versioning from reviews, certifications, international
                  rollout.
                </li>
              </ul>
            </div>
            <div>
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="stat flex flex-col items-center justify-center bg-gray-100 border border-gray-200 p-4 rounded-xl text-center">
                  ...
                  <span className="text-gray-700 text-sm mt-1">Ops & CRM</span>
                </div>
              </div>
      ...
      <section id="engagement" className="py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="price-card bg-gray-100 border border-gray-200 rounded-lg p-5">
            <h4 className="font-bold text-lg mt-1 mb-1">Private Label Build</h4>
      ...
      <section id="faq" className="py-16">
        <div className="flex flex-col sm:flex-row items-start sm:items-baseline justify-between gap-4 mb-5">
          ...
          <p className="text-gray-700 max-w-3xl">
            Short answers to common questions. Need more detail? Drop us a line.
          </p>
        </div>
        <details className="bg-gray-100 border border-gray-200 rounded-lg p-4 mb-2">
          ...
          <p className="text-gray-700 mt-2">
            ...
            sourcing, branding, site build, and pre‑launch marketing. Timelines
            depend on sampling and compliance.
          </p>
        </details>
        <details className="bg-gray-100 border border-gray-200 rounded-lg p-4 mb-2">
          <summary className="cursor-pointer font-bold">
          ...
          <p className="text-gray-700 mt-2">
            Yes — we can optimize your current stack, migrate platforms, or plug
            into your ops for growth (ads, CRO, CRM, marketplaces).
          </p>
        </details>
