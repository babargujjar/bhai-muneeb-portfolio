      ...
      <div className=" w-full grid md:grid-cols-2 gap-8">
        ...
        <div className="text-black sm:p-8 rounded-lg">
          ...
          <p className="mb-6 text-gray-500">
            At Betelbee, we’re always open to new opportunities, collaborations,
            and conversations. Whether you’re looking for innovative solutions,
            creative insights, or just want to say hello we’re here for you
            24/7.
          </p>
      ...
      <div className="p-8 flex md:flex-row flex-col gap-5 bg-black justify-between rounded-md border-gray-200 items-center w-full border mt-10">
        <div className="flex flex-col text-white gap-10 justify-between">
          <div className="w-full">
            ...
            <p className="text-md">
              Partner with Betelbee to get your digital <br /> marketing done right
              with strategy, <br /> creativity, and results.
            </p>
          </div>
          <div className="text-md flex gap-4">
            <h2>
              <span className="font-bold text-lg">2021</span> <br /> Founded in
            </h2>
            <h2>
              <span className="font-bold text-lg">3k+</span> <br /> eCommerce Stores <br /> Lounched
            </h2>
            <h2>
